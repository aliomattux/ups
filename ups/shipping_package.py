...
#        'sandbox': "https://wwwcie.ups.com/ups.app/xml",
	'sandbox': "https://www.ups.com/ups.app/xml",
...
class ShipmentConfirm(BaseAPIClient):
    ...
    @classmethod
    def reference_type(cls, *args, **kwargs):
        """
        :param Code: 02
        :param Value: Transaction Reference
        """
    ...
    def package_type(cls, *args, **kwargs):
        ...
        elements = cls.make_elements(
            ['PackagingType', 'PackageWeight', 'Dimensions', 'ReferenceNumber'], args, kwargs)
